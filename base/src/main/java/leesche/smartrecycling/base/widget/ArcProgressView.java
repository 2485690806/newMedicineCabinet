...
public class ArcProgressView extends View {
    ...
    private boolean isStepFlow = false;

    public void setStepFlow(boolean stepFlow) {
        isStepFlow = stepFlow;
    }
    ...
    public ArcProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int defaultCircleSize = 15; //默认圆弧大小 单位sp
...
//    }
    ...
    public void setCurrentNum(double currentNum) {
        ...
        mText =  new DecimalFormat("0.00%").format(mCurrentNum/mMaxNum);
//        if (!isStepFlow) {
//            if (mCurrentAngle > 90 && mCurrentAngle < 180) {
//                mText = "2";
//            }
//            if (mCurrentAngle > 180 && mCurrentAngle < 320) {
//                mText = "1";
//            }
//            if (mCurrentAngle > 320) {
//                mText = "0";
//            }
//        } else {
//            mText = (int) (currentNum / 1000) + "";
//        }
        invalidate();
    }
}
