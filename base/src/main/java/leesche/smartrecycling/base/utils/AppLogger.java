...
public class AppLogger {
    ...
    static private String DEFAULT_LOG_FILE_NAME = "wawaji_server_business.txt";
    static private String DEFAULT_LOG_FILE_NAME_BAK = "wawaji_server_business_2.txt";
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case MSG_ID_WRITE_LOG: {
                        ...
                        String timeStr = DateUtil.getLogStr();
    ...
    private void initLogFile() {
        String logPath = FileUtil.createDir(Constants.LOG_CACHE_DIR).getAbsolutePath();
        String logFileName = DEFAULT_LOG_FILE_NAME;
        String bakFileName = DEFAULT_LOG_FILE_NAME_BAK;
        if (!OSUtils.isMainProcess(DevContext.getInstance().getContext())) {
