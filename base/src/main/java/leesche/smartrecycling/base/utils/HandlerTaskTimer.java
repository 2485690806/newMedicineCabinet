...
public class HandlerTaskTimer {
    ...
    private HandlerTaskTimer(Context context) {
        uiHandler = new WeakHandler(context.getMainLooper(), callback);
    }

    public static HandlerTaskTimer getInstance(Context context) {
        if (instance == null) {
            synchronized (HandlerTaskTimer.class) {
                if (instance == null) {
                    instance = new HandlerTaskTimer(context);
                }
            }
        }
        return instance;
    ...
    public class Builder {
         ...
         * @return
         */
        public Builder accept(io.reactivex.rxjava3.functions.Consumer<Long> consumer, Action action) {
            this.action = action;
            return this;
        }
