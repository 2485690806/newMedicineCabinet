...
public class GreenDaoContext  extends ContextWrapper {
    private String currentUserId = "SmartRecycling";//一般用来针对一个用户一个数据库，以免数据混乱问题
...
//        this.currentUserId = "greendao";//初始化
    ...
    public File getDatabasePath(String dbName) {
        String mainDir = Constants.SDCARD_DIR + File.separator + "ycMachineDatabase";
        FileUtil.createDir(mainDir);
        String dbDir = mainDir + File.separator;
