...
public class OpenDoorSuccessDialog extends Dialog {
    ...
    public OpenDoorSuccessDialog(@NonNull Context context) {
        super(context);
    }

    public OpenDoorSuccessDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected OpenDoorSuccessDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_opendoorsuccess);
    }
