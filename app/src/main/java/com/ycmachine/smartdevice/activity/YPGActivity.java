...
public class YPGActivity extends BaseActivity implements HomeFragmentListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        nowLanIndex = (int) SharedPreferencesUtils.get(this, LanguageUtil.LAST_SET_LAN, 0);
...
//        HeatParser.getInstance().snapDevice();
    ...
    public void changeLanguage(View view) {
        // 获取当前已保存的语言索引（默认0）
        int currentLanIndex = (int) SharedPreferencesUtils.get(this, LanguageUtil.LAST_SET_LAN, 0);
